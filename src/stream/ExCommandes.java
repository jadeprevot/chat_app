...
class ExCommandes implements Runnable
{
    ExServer _blablaServ; // pour utilisation des méthodes de la classe principale
    ...
    ExCommandes(ExServer server)
    {
        _blablaServ = server; // passage de local en global
